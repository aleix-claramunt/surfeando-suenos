...
export default function EasyFlowPage() {
  return (
    <>
      <Navbar alwaysSolid />
      <main className="bg-gray-50 min-h-screen">
        ...
        <section className="max-w-4xl mx-auto text-center pt-24 pb-10 px-6">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Perfecto para quienes buscan {' '}
              <span className="text-indigo-600 font-semibold">flexibilidad</span> y{' '}
              <span className="text-indigo-600 font-semibold">confort</span> sin perder la esencia del surf trip.{' '}
            </p>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-6 pb-10">
          <PackageCard
            ...
            message="¡Hola! Me gustaría reservar un paquete Easy Flow de 7 días. ¿Hablamos?"
          />
          <PackageCard
            ...
            features={[
              ...
              '2 clases de Yoga (Hatha o Vinyasa, 1h cada sesión)',
              'Material equipo de surf (tabla y traje de neopreno) & yoga',
              'Wifi disponible en Surf house',
            ]}
            message="¡Hola! Me gustaría reservar un paquete Easy Flow de 5 días. ¿Hablamos?"
          />
        </section>
        <div className="text-center">
          <Link 
